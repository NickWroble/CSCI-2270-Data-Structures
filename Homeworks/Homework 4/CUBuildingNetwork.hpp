...
class CUBuildingNetwork {
    ...
    public:
        ...
        /* For you to complete */
        void deleteCUBuilding(string buildingName); //done 
        void deleteEntireNetwork(); //done
        void readjustNetwork(int start, int end); //done
        bool detectLoop(); //done
        CUBuilding* createLoop(std::string buildingName); //done  
};