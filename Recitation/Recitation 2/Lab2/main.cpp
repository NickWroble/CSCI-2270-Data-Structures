...
int main(int argc, char const *argv[])
{
  ...
  int foo[5] = {1, 2, 3, 4, 5};
  int *arrayLocation = foo;

  cout << "Addresses of elements:" << endl;
  //DONE TODO Print the addresses of array elements 
  for(int i = 0; i < 5; i++) cout<<&(foo[i])<<endl;

  cout << endl;

  cout << "Elements:" << endl;;
  // DONE TODO Print all the elements using pointers
  for(int i = 0; i < 5; i++) cout<<*(arrayLocation + i)<<endl;
  ...
  while(flag == 1){
    ...
    switch (f) {
      ...
      case 1:
        ...
        //DONE TODO complete the function in swap.cpp file
